      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            {{-- <form> --}}
            {{Form::open(array('action'=>'LoginController@login','method'=>'post','files'=>true))}}
              <h1>Login Form</h1>
              <div>
                {{-- <input type="text" class="form-control" placeholder="Username" required="" /> --}}
                {{Form::text('username','',['placeholder'=>'Username','required'=>'','class'=>'form-control'])}}
              </div>
              <div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Ristekdikti!</h1>
                  <p>©2018 Ratisa Media Citra All. Rights Reserved. </p>
                </div>
              </div>
            {{Form::close()}}
          </section>
