...
<html lang="en">
  <head>
    ...
    <link href="{{url('public/build/css/custom.min.css')}}" rel="stylesheet">
     ...
     <link href="{{url('public/lib/select2/select2.css')}}" rel="stylesheet">
  </head>
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_info">
                ...
                {{session('username')}}
                <a href="{{route('post')}}">
                <button class="btn-sm btn-success">Post Berita</button>
              </a>
                <br>
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i>Berita<span class="fa fa-chevron-down"></a>
                  ...
                  <?php $aku = "aku adalah anak gembala selalu riang serta gembaria";?>
                <li><a href="{{route('grafik')}}"><i class="fa fa-pie-chart"></i>Grafik</a></li>
                <li><a href="{{route('cari')}}"><i class="fa fa-search"></i>Pencarian</i></li>
                </ul>
